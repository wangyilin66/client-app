<template>
	<view class="container">
		...
		<module-box :hasMargin="false">
			<icon-grid :gridData="mainIcon" :fontSize="30" :rowNum="3" :imgSize="100"></icon-grid>
			<icon-grid :gridData="minorIcon" :flexWrap="'wrap'" :rowNum="5" :imgSize="86"></icon-grid>
		</module-box>
...
<script>
	...
	import newsCard from './news-card/news-card.vue'
